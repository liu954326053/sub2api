...
func init() {
	...
	// apikeyDescCursorDedicated is the schema descriptor for cursor_dedicated field.
	apikeyDescCursorDedicated := apikeyFields[5].Descriptor()
	// apikey.DefaultCursorDedicated holds the default value on creation for the cursor_dedicated field.
	apikey.DefaultCursorDedicated = apikeyDescCursorDedicated.Default.(bool)
